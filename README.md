...
http://search.maven.org/#artifactdetails|com.bitplan.rest|com.bitplan.simplerest|0.0.5|jar
...
```
## Tests
There are 16 JUnit test for version 0.0.5
...
* 0.0.5: 2017-03-10 suppor Rythm Template Engine